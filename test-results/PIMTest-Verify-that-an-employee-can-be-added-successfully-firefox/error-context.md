...
- Name: PIMTest.spec.ts >> Verify that an employee can be added successfully
- Location: tests\PIMTest.spec.ts:16:5
...
Expected: false
Received: "Cannot read properties of undefined (reading 'locator')"
```
...
- generic [ref=e1]:
  - list [ref=e5]:
    - listitem [ref=e6]: Welcome selenium
    - listitem [ref=e7]:
      - link "Change Password" [ref=e8] [cursor=pointer]:
        - /url: ./lib/controllers/CentralController.php?mtcode=CPW&capturemode=updatemode&id=USR001
    - listitem [ref=e9]:
  ...
  - iframe [active] [ref=e292]:
    - generic [ref=f1e8]:
      ...
      - generic [ref=f1e11]:
        ...
        - textbox "Search For:" [ref=f1e15]: Hanu
        - button "Search" [active] [ref=f1e16]
          ...
          - row "Employee Id Employee Name Job Title Employment status Sub-Division Supervisor" [ref=f1e25]:
            ...
            - cell "Supervisor" [ref=f1e38]:
              - link "Supervisor" [ref=f1e39] [cursor=pointer]:
                - /url: "#"
        - rowgroup [ref=f1e40]:
          - row "0388 Hanu DSu - - - -" [ref=f1e41]:
            - cell [ref=f1e42]:
              - checkbox [ref=f1e43]
            - cell "0388" [ref=f1e44]
            - cell "Hanu DSu" [ref=f1e45]:
              - link "Hanu DSu" [ref=f1e46] [cursor=pointer]:
                - /url: ./CentralController.php?menu_no_top=hr&id=0388&capturemode=updatemode&reqcode=EMP&currentPage=1
            - cell "-" [ref=f1e47]
            - cell "-" [ref=f1e48]
            - cell "-" [ref=f1e49]
            - cell "-" [ref=f1e50]
          - row "0389 Hanu DSu - - - -" [ref=f1e51]:
            - cell [ref=f1e52]:
              - checkbox [ref=f1e53]
            - cell "0389" [ref=f1e54]
            - cell "Hanu DSu" [ref=f1e55]:
              - link "Hanu DSu" [ref=f1e56] [cursor=pointer]:
                - /url: ./CentralController.php?menu_no_top=hr&id=0389&capturemode=updatemode&reqcode=EMP&currentPage=1
            - cell "-" [ref=f1e57]
            - cell "-" [ref=f1e58]
            - cell "-" [ref=f1e59]
            - cell "-" [ref=f1e60]
          - row "0390 Hanu DSu - - - -" [ref=f1e61]:
            - cell [ref=f1e62]:
              - checkbox [ref=f1e63]
            - cell "0390" [ref=f1e64]
            - cell "Hanu DSu" [ref=f1e65]:
              - link "Hanu DSu" [ref=f1e66] [cursor=pointer]:
                - /url: ./CentralController.php?menu_no_top=hr&id=0390&capturemode=updatemode&reqcode=EMP&currentPage=1
            - cell "-" [ref=f1e67]
            - cell "-" [ref=f1e68]
            - cell "-" [ref=f1e69]
            - cell "-" [ref=f1e70]
          - row "0391 Hanu DSu - - - -" [ref=f1e71]:
            - cell [ref=f1e72]:
              - checkbox [ref=f1e73]
            - cell "0391" [ref=f1e74]
            - cell "Hanu DSu" [ref=f1e75]:
              - link "Hanu DSu" [ref=f1e76] [cursor=pointer]:
                - /url: ./CentralController.php?menu_no_top=hr&id=0391&capturemode=updatemode&reqcode=EMP&currentPage=1
            - cell "-" [ref=f1e77]
            - cell "-" [ref=f1e78]
            - cell "-" [ref=f1e79]
            - cell "-" [ref=f1e80]
  - generic [ref=e293]:
    - link "OrangeHRM" [ref=e294] [cursor=pointer]:
      - /url: http://www.orangehrm.com
    - text: ver 2.5.0.2 © OrangeHRM Inc. 2005 - 2009 All rights reserved.
```
...
```ts
  ...
  2  | 
  3  | export class AssertUtil {
  4  | 
  5  | 
  6  | static assertEquals(actual:string,expected:string):void
  7  | {
  8  |     if(actual === expected)
  9  |     {
  10 |            console.log("Expected: " + expected + " is matched with Actual: " + actual);
  11 |     }else{
  12 |            console.log("Expected: " + expected + " is not matched with Actual: " + actual);
  13 |     } 
  14 | }
  15 | static assertTrue(actual: boolean) {
  16 |     expect(actual).toBe(true); 
  17 |   }
  18 | 
  19 |   /*
  20 |   static async assertTrue(actual: boolean) {
  21 |     expect(true).toBe(true); 
  22 |   }
  23 | */
  24 |   static  assertFalse(actual: boolean) {
> 25 |     expect(actual).toBe(false); 
     |                    ^ Error: expect(received).toBe(expected) // Object.is equality
  26 |   }
  27 | }
```